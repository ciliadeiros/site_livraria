...
- Implementar autenticação:
  ...
  - Página de login  ✔ (Camila)
  - Senha com hash seguro ✔ (Filipe)
  - Sessão ou Flask-Login para manter usuário autenticado ✔ (Filipe)
- Logout funcional ✔ (Camila)
- Templates com extends/includes para base e navbar (barra de navegação) ✔ (Demilly)

## Semana 3 (18/07–24/07)
- Implementar CRUD do recurso escolhido: ✔ (Todos)
  - Criar 
  - Listar
  - Editar
  - Excluir
- Restrição de acesso: cada usuário só pode ver/editar/excluir seus dados  ✔ (Cecília)
...
- Estilização básica com CSS ou Bootstrap ✔ (Todos)
- Ajustes finais no código ✔ (Todos)
- README bem elaborado:  ✔ (Cecília)
...
- README com instruções claras ✔ (Cecília)
